...
int main() {
	...
	Menu sincham_menu_list[5] = {
		Menu(3, "떡볶이", "떡볶이", 4000, 3, jaws_option, jaws_option_price),
		Menu(3, "라볶이", "라볶이", 5500, 3, jaws_option, jaws_option_price),
		Menu(3, "찰순대", "찰순대", 3500, 3, jaws_option, jaws_option_price),
		Menu(3, "모듬 튀김", "모듬 튀김", 4000, 3, jaws_option, jaws_option_price) };
